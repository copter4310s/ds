<?php
	...
	$changelog = "<font size='4'>" . _PLEASE_LOGIN . "</font>";
	
	if ($auth AND $authuser != "guest") {
		$myfile = fopen("./module/changelog.txt", "r") or die(_CANNOT_READ_FILE);
		$changelog = fread($myfile,filesize("./module/changelog.txt"));
		fclose($myfile);
	} else {
		//AUTH FAIL
		$changelog = "<font size='4'>" . _PLEASE_LOGIN . "</font>";
